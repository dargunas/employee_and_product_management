...
public class UserMenu {
    ...
    public void menuForUser() {
        ...
        System.out.println("    1 <-- Modify employees owned products PRESS                                   -> 1 <-");
        System.out.println("    2 <-- Add worked hours of product and mark product's state PRESS              -> 2 <-");
        System.out.println("    3 <-- Add employee.json PRESS                                                 -> 3 <-");
        System.out.println("    4 <-- Add product PRESS                                                       -> 4 <-");
        System.out.println("    5 <-- Delete Employee                                                         -> 5 <-");
        System.out.println("    6 <-- Delete Product                                                          -> 6 <-");
        System.out.println("    7 <-- Show all Employees                                                      -> 7 <-");
        System.out.println("    8 <-- Show all Products                                                       -> 8 <-");
        System.out.println("    9 <-- Exit menu PRESS                                                         -> 9 <-");
        System.out.println(" <-------------------------------------------------------------------------------------->");
    ...
    public void subMenuForDeletingEmployee() {
        ...
        System.out.println("<------------------- Write employee.json Id what you prefer to delete-----------------------> ");
        System.out.println();
        Integer employeeId = scanner.nextInt();
